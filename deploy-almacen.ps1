...
$backupBase     = "\\$servidor\c$\inetpub\wwwrootssl\_backups\API_Almacen"
...
$dllPath = "$destino\API_Almacen.dll"
$liberado = $false
$intentos = 0
...
Invoke-Command -ComputerName $servidor -ScriptBlock {
    $webConfigPath = "C:\inetpub\wwwrootssl\API_Almacen\web.config"
    $content = @'
...
<configuration>
  <location path="." inheritInChildApplications="false">
    <system.webServer>
      ...
      <aspNetCore processPath="dotnet" arguments=".\API_Almacen.dll" stdoutLogEnabled="false" stdoutLogFile=".\logs\stdout" hostingModel="inprocess">
...
$healthUrl = "https://net.onventanas.es/API_Almacen/api/health"
$intentos  = 0
$ok        = $false
